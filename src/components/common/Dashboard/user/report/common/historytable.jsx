      ...
      <table class="table-auto w-full">
        ...
        <tbody className="w-full">
          <tr className="grid grid-cols-7">
            ...
            <td className="border p-2 px-6">
              <button className="bg-black text-white rounded-lg px-6 py-2 text-sm">
                90 rwf
              </button>
            </td>
            ...
            <td className="border p-2 px-6">
              <button className="bg-green-200 rounded-lg px-6 py-2 text-sm">
                Paid
              </button>
            </td>
          </tr>
          ...
          <tr className="grid grid-cols-7 bg-blue-50 rounded-b-2xl">
            ...
            <td className="p-2 px-6">
              <button className="bg-red-200 rounded-lg px-6 py-2 text-sm">
                Paid
              </button>
            </td>
          </tr>
