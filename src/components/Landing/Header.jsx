  ...
  return (
    <div className='w-full bg-white/80 px-4 lg:px-12 py-6 flex justify-between items-center fixed backdrop-blur-md z-50'>
      ...
      <ul className='gap-4 hidden md:flex items-center justify-end'>
        <Link
          href='#operate'
          className='py-2 px-4 bg-transparent hover:bg-slate-100 duration-300 hover:scale-105 rounded-md'
        >
          How we works
        </Link>
        <Link
        ...
        <Link
          href='/auth/signin'
          className=' bg-transparent border-black border rounded-md px-4 py-2 duration-300 hover:scale-105'
        >
          Sign in
        </Link>
        <Link
          href='/auth'
          className='bg-black text-white rounded-md px-4 border-black border py-2 duration-300 hover:scale-105 flex gap-2 items-center'
        >
          <TbUserCircle />
          Sign up
        </Link>
