...
import AddLoan from "@/components/common/Dashboard/admin/restaurant/modal/addloan";
...
const TabNav = ({ Users, setSelectedTr, selectedTr, handleRowClick }) => {
  ...
  const userHandleModal = () => setAddLoanModal((prev) => !prev);
  ...
  return (
    <div className='mt-4 w-full'>
      <div className='w-full flex justify-between items-center my-3'>
        ...
        />
        {addLoanModal && <AddLoan closeModal={userHandleModal} />}
      </div>
